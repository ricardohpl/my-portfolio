  ...
  return (
    <Flex flexDir={'column'} w='95%'>
      ...
      <Box paddingX={['25px', '25px', '45px']} w={['100%']}>
        <Text marginY={4}>Formado na Fatec-SP, tenho mais de 12 anos de experiência na area de TI trabalhando com diferentes papéis. Atualmente estou trabalhando como
          Desenvolvedor Web mas já atuei como Administrador de Dados, Líder de Equipe, Product Owner e Analista de Negócios\Requisitos.
        </Text >
